...
var animals = ["Cat", "Dog", "Mouse", "Lion", "Cow", "Wolf", "Bug", "Elephant", "Frog", "Killer Whale","Bear", "Chicken", "Pig"];
...
// Function to remove added animal buttons - Acts as a refresh of the page
...
function displayGifs(){
    ...
    .done(function(response) {
        console.log(response); // console test to make sure it returns something
